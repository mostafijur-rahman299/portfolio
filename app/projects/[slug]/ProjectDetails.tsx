    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16 max-w-7xl">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-orange-700 to-orange-900">
            {projectData.title}
          </h1>
          <p className="text-base sm:text-lg text-orange-700 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-8">
            ...
            {/* Project Goals Card */}
            <Card className="border-2  shadow-lg bg-white mt-6">
              ...
              <CardContent className="space-y-4">
                {projectData.project_goals?.map((goal: string, index: number) => (
                  <div key={index} className="flex items-start space-x-3">
                    ...
                    <p className="text-orange-700">{goal}</p>
                  </div>
                )) || (
                  <p className="text-orange-600">Project goals not specified</p>
                )}
              </CardContent>
            </Card>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <Card className="border-2  shadow-lg bg-white">
              <CardHeader className="pb-3">
                <CardTitle className="text-xl text-orange-800">Project Overview</CardTitle>
              </CardHeader>
              <CardContent className="space-y-5">
                <div className="flex items-center text-orange-700 hover:bg-orange-50 p-2 rounded-lg transition-colors">
            ...
            <Card className="border-2  shadow-lg bg-white">
              <CardHeader className="pb-3">
                <CardTitle className="text-xl text-orange-800">Technologies Used</CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <ul className="space-y-3">
                  {projectData.key_features?.map((feature: string, index: number) => (
                    ...
                    <li className="text-orange-600 text-sm">Features not specified</li>
                  )}
                </ul>
              </CardContent>
            </Card>
            ...
            <div className="flex flex-col gap-4">
              {projectData.demoLink && (
                <Button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white w-full py-6 text-lg shadow-lg">
                  <a
              ...
              {projectData.githubLink ? (
                <Button 
                  variant="outline" 
                  className="border-2 border-orange-500 text-orange-700 hover:bg-orange-50 w-full py-6 text-lg"
                >
                  <a
                ...
                <p className="text-sm text-orange-600 text-center bg-orange-50 p-3 rounded-lg">
          ...
          <Tabs defaultValue="about" className="w-full">
            <div className="overflow-x-auto">
              <TabsList className="w-full flex flex-nowrap md:flex-wrap gap-1 md:gap-2 justify-start  mb-6 bg-transparent p-1 min-w-max md:min-w-0">
                <TabsTrigger 
                  value="about" 
                  className="whitespace-nowrap flex-shrink-0 md:flex-1 w-[120px] md:min-w-[100px] md:max-w-[150px] data-[state=active]:bg-orange-500 data-[state=active]:text-white data-[state=active]:shadow-md px-3 py-2.5 text-xs md:text-sm lg:text-base rounded-md transition-all duration-200 hover:bg-orange-100"
                >
                  About Project
                </TabsTrigger>
                <TabsTrigger 
              ...
              <TabsContent value="about" className="focus-visible:outline-none">
                <Card className="border-2  shadow-lg bg-white transform transition-all duration-300 hover:shadow-xl">
                  <CardContent className="p-3 sm:p-4 md:p-6 lg:p-8">
                    <p className="text-orange-800 text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
