    ...
    <motion.div key="skills" variants={tabVariants} initial="hidden" animate="visible" exit="exit">
      <div className="grid grid-cols-1 gap-6 
        ...
        {Object.entries(skills).map(([category, categorySkills]) => (
          ...
          >
            <CardHeader>
              <CardTitle className="text-2xl font-semibold text-pink-300 capitalize">{category}</CardTitle>
            </CardHeader>
            <CardContent>
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {education.map((edu, index) => (
          <Card
            key={edu.degree}
            className="bg-white/10 backdrop-blur-md rounded-lg overflow-hidden border border-gray-800 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20"
          >
            {/* Card Header */}
            <CardHeader className="relative pb-0">
              <div className="absolute top-0 right-0 w-14 h-14 bg-gradient-to-br from-pink-500 to-purple-600 rounded-bl-full flex items-center justify-center transform transition-all duration-300 hover:scale-110">
                <GraduationCap className="text-white w-6 h-6 sm:w-8 sm:h-8" />
              </div>
              <CardTitle className="text-xl sm:text-2xl text-gray-200">
                {edu.degree}
              </CardTitle>
              <CardDescription className="text-gray-300 text-sm sm:text-lg">
                {edu.school} | {edu.year}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              ...
              <h4 className="text-base sm:text-lg font-semibold text-pink-300 mb-2">
                Key Courses:
              </h4>
      ...
      <CardContent>
        <motion.div className="mb-4 flex flex-wrap" layout>
          {project.skills.map((skill, index) => (
            ...
            >
              <Badge className="mr-2 mb-2 bg-white/20 text-white">{skill}</Badge>
            </motion.div>
          ))}
        </motion.div>
...
function ServicesComponent() {
  ...
  return (
    <motion.div key="services" variants={tabVariants} initial="hidden" animate="visible" exit="exit">
          ...
          >
            ...
            <CardContent>
              <motion.div
                initial={{ height: 0 }}
                animate={{
                  height: expandedService === service.name ? "auto" : "80px",
                }}
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        ...
        >
          <div className="relative inline-block mx-auto lg:mx-0">
            <motion.div className="relative" animate={controls} onHoverStart={handleHover} onHoverEnd={handleHover}>
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-pink-200">
            Mostafijur Rahman
          </h1>
...
const testimonials = [
  {
    ...
    role: "CEO, TechCorp",
    content:
      "Mostafijur's work on our project was exceptional. His attention to detail and problem-solving skills are unmatched.",
  ...
  },
  {
    ...
    content:
      "Working with Mostafijur was a pleasure. He delivered high-quality code and was always responsive to our needs.",
    avatar: "/placeholder.svg?height=100&width=100",
  },
  {
    name: "Alex Johnson",
    ...
    content:
      "Mostafijur's expertise in both frontend and backend development was crucial to the success of our project.",
    avatar: "/placeholder.svg?height=100&width=100",
  },
]
...
export function TestimonialSection() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-900/50 to-purple-800/50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Card className="h-full bg-white/10 backdrop-blur-md border-none hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300">
                <CardContent className="p-6 flex flex-col h-full">
                  <Quote className="w-10 h-10 text-pink-400 mb-4" />
                  <p className="text-white/90 mb-4 flex-grow">{testimonial.content}</p>
