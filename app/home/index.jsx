        ...
        <div className="min-h-screen bg-gradient-to-br from-lime-100 via-emerald-200 to-teal-300 text-foreground overflow-hidden flex items-center justify-center">
            ...
            <main className="relative z-10 container mx-auto px-4 max-w-6xl">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    >
                        <div className="relative inline-block">
                            <Image
                                ...
                                width={500}
                                height={500}
                                className="rounded-full border-8 border-emerald-500 shadow-2xl"
                            />
                            <motion.div
                    ...
                    >
                        <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600">
                            Your Name
                        </h1>
                        <p className="text-3xl text-emerald-700 mb-6">
                            Full-Stack Developer & Tech Innovator
                        </p>
                        <p className="text-xl text-emerald-600 mb-8">
                            Crafting cutting-edge digital experiences and
                            pushing the boundaries of technology. Passionate
                            about creating innovative solutions that make a
                            difference.
                        </p>
            ...
            >
                <ChevronDown className="h-8 w-8 text-emerald-700 animate-bounce" />
            </motion.div>
        </div>
    );
}
