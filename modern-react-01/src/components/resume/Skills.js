        ...
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              ...
              >
                <span className="absolute -top-7 right-0">Intermediate</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Django & DRF</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
              ...
              >
                <span className="absolute -top-7 right-0">Expert</span>
              </motion.span>
            </span>
          </div>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              ...
              >
                <span className="absolute -top-7 right-0">Beginner</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
